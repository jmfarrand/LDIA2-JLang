...
public class BaseASTNode {
    ...
    //Set to true whether the if statement contains an elseif statement.
    public boolean ifHasElseIf = false;

    //Set to true if a switch statement has a default statement
    public boolean switchHasDefault = false;
